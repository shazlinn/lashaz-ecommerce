...
// 2. The main page component that provides the layout and Suspense boundary
        ...
        <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center bg-white">
          <Suspense fallback={
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <p className="text-xs font-josefin uppercase tracking-widest text-zinc-400">Loading Protocol...</p>
            </div>
          }>
            <LoginForm />
          </Suspense>
